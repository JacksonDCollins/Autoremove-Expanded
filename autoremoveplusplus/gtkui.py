...
class Gtk3UI(Gtk3PluginBase):
    ...
    def enable(self):
        log.debug("Enabling AutoRemovePlusPlus...")
        ...
        client.autoremoveplusplus.get_remove_rules().addCallback(self.cb_get_rules)
        ...
        def on_menu_show(menu, xxx_todo_changeme):
            ...
            client.autoremoveplusplus.get_ignore([t for t in component.get("TorrentView").get_selected_torrents() ]).addCallback(set_ignored)

        def on_menu_toggled(menu):
            client.autoremoveplusplus.set_ignore(component.get("TorrentView").get_selected_torrents(), menu.get_active())

        self.menu = Gtk.CheckMenuItem(_("AutoRemovePlusPlus Exempt"))
        self.menu.show()
    ...
    def disable(self):
        component.get("Preferences").remove_page("AutoRemovePlusPlus")
    ...
    def on_apply_prefs(self):
        log.debug("applying prefs for AutoRemovePlusPlus")
        ...
        client.autoremoveplusplus.set_config(config)

    def on_show_prefs(self):
        client.autoremoveplusplus.get_config().addCallback(self.cb_get_config)
